...
DELETE FROM RPT_RENTABILITE WHERE COMPTE = 701260000 AND CATEGORIE = 'Consolidé' AND DATE_ARRETE = TO_DATE('2026-06-30','YYYY-MM-DD');

INSERT INTO RPT_RENTABILITE (RUBRIQUE, COMPTE, CHAPITRE, SOLDE, CATEGORIE, DATE_ARRETE) VALUES ('Intérêts payés', 701260000, '701260000  INTERETS SUR DAT', -1958024.0, 'Consolidé', TO_DATE('2026-06-30','YYYY-MM-DD'));
